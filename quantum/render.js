(function () {
  ...
  function renderDirectory() {
    ...
    if (!target) return;
    target.innerHTML = group.sections.map((section) => {
      const people = group.people.filter((person) => person.section === section.id);
  ...
  function renderMember() {
    ...
    target.innerHTML = `<section class="profile-hero quantum-profile-hero"><div class="shell profile-hero-grid">
      ...
      <section class="section profile-content-section"><div class="shell profile-layout">
        <aside class="profile-quote"><p class="eyebrow">Group role</p><blockquote>${escapeHtml(person.groupRole)}</blockquote></aside>
  ...
  function initialize() {
    ...
    renderResearch(); renderLeadershipPreview(); renderDirectory(); renderMember();
  }
